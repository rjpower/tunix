...
for v in OTA_MODEL OTA_DATASET OTA_SEQ OTA_BATCH OTA_PDP OTA_TP OTA_STEPS OTA_LR OTA_WARMUP OTA_HF_EXPORT OTA_CKPT_MINUTES OTA_OUTPUT OTA_CACHE OTA_RUN OTA_INIT_FROM OTA_CONVERT_OUTPUT OTA_GRAD_CKPT OTA_ATTN OTA_FLASH_BLOCK OTA_DATA_DCN; do
